					...
					ISNULL(STRING_AGG((CONVERT(NVARCHAR(MAX),(
								CASE 
									WHEN d.[DataSetType] = 'MSSQL'
										THEN '[' + o.[MetadataObjectName] + ']  AS [' +ME_Data.fn_StripNonSupportedPqtColChars(o.[MetadataObjectName],'_') + ']'
									WHEN d.[DataSetType] = 'ORACLE'
										THEN '"' + o.[MetadataObjectName] + '"  AS "' + ME_Data.fn_StripNonSupportedPqtColChars(o.[MetadataObjectName],'_') + '"'
									ELSE '`' + o.[MetadataObjectName] + '`  AS `' + ME_Data.fn_StripNonSupportedPqtColChars(o.[MetadataObjectName],'_') + '`'
									END
								))), ',') WITHIN GROUP (
